...
/**
 * A panel that displays the candidates and their respective vote counts for the Mayor election.
 */
public class MayorPanel extends javax.swing.JPanel implements LanguageManager.LanguageChangeListener {
    ...
    /**
     * Creates a new instance of MayorPanel and initializes the components.
     */
    public MayorPanel() {
        initComponents();
    ...
    private void updateTitle(int languageIndex) {
        ...
        String[] titles = {"City Mayor", "Alcalde de la Ciudad", "Мэр города"}; // English, Spanish, Russian

...
public class ReviewAndSubmit extends javax.swing.JPanel {
    String mayorFinal;
    String councilFinal;
    String governorFinal;
    String senatorFinal;
    String presidentFinal;
    String congressFinal;
    ...
    public void sendResults(ActionEvent evt){
         ...
         // Define file path
        String filePath = "Client/src/UserGUI/resources/Results.txt";
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon("vote background.png")); // NOI18N
